...
def gen_image_modified(dataframe,col_name,img_h=200,img_w=200):
  m=list(dataframe[col_name]);
  train_images = numpy.array(m).reshape( (len(dataframe[col_name]),img_h,img_w,1));
  return train_images

def gen_label(dataframe,col_name):
